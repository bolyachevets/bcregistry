...
export default {
  ...
  contactInfo: {
    bcRegGeneral: {
      ...
      hours: {
        ...
        value: "Monday to Friday, 9:00 a.m. to 4:00 p.m Pacific Time",
      },
    },
    bcros: {
      moreInfo: {
  ...
  page: {
        ...
        features: {
          ...
          cards: {
            search: {
              ...
              description:
                "A new, easy-to-use application that offers improved searching and registering.",
            },
            records: {
              title: "Organized Records",
              description:
                "Registrations, searches and downloadable documents are saved to your dashboard.",
            },
            account: {
              title: "Account Integration",
              description:
                "Access to all of your BC Registries products and services from one location.",
            },
            api: {
              title: "API Services",
              description:
                "Are you a high-volume account user? Ask about our Personal Property Registry APIs.",
            },
          },
        },
        helpfulLinks: {
    ...
    dashboard: {
      ...
      products: {
        ...
        error: {
          ...
          description:
            "There was an error fetching your products, please refresh the page or try again later.",
        },
        empty: {
          title: "No Products Found",
          description:
            "No products were found associated with this account. To add products and services, contact the account Administrator of your BC Registries account.",
        },
      },
      help: {
        addProds: {
    ...
    productFees: {
      ...
      note: "Note:",
      noteContent:
        "A priority fee or future effective fee adds an extra $100.00 to the total cost.",
      variableFeeNote:
        "Fees indicated with an asterisk (*) in the description have a variable amount and may differ from the amount shown.",
      table: {
        header: {
          service: "Description",
  ...
  test: {
    i18nBold: {
      ...
      strongWithProps:
        "This should have {boldStart} bold {boldEnd} text and allow a {prop}",
    },
  },
};
